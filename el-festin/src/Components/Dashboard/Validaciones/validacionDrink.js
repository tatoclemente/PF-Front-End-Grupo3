const validacionDrink = (input) =>{
    ...
    if(!input.volume){
        errors.volume = "El volumen es obligatorio"
    } else if(!/^[0-9]+$/.test(input.volume)){
        errors.volume = "El volumen debe ser un numero"
    } else if(parseInt(input.volume) < 0){
        errors.volume = "El volumen no puede ser negativo"
    } else if(parseInt(input.volume) > 3000){
        errors.volume = "El volumen no puede ser mayor a 3000"
    }
...
module.exports = {validacionDrink}
