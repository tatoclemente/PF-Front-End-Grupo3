...
export const Navbar = () => {
  return (
    <>
      <nav className="navbar p-0 navbar-expand-lg navbar-light navbarLanding py-2 fixed-top">
        <div className="container-fluid justify-content-between py-2">
          <a className="navbar-brand d-none d-lg-block ps-lg-5" href="/*">
      ...
      <div
        className="offcanvas offcanvas-end w-75 bg-dark d-lg-none d-sm-block"
        tabindex="-1"
        id="offcanvasRight"
        aria-labelledby="offcanvasRightLabel">
        <div className="offcanvas-header justify-content-center ps-3">
          <h5 id="offcanvasRightLabel" className=" text-white pt-5">Bienvenidos al menu!</h5>
          <button
            type="button"
